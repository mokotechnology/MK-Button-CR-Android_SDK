...
public class DeviceInfoActivity extends BaseActivity implements RadioGroup.OnCheckedChangeListener {
    ...
    public void modifyPassword(String password) {
        ...
        showSyncingProgressDialog();
        CRMokoSupport.getInstance().sendOrder(OrderTaskAssembler.setNewPassword(password));
    }

    public void resetDevice() {
        showSyncingProgressDialog();
        CRMokoSupport.getInstance().sendOrder(OrderTaskAssembler.resetDevice());
    }

    public void setClose() {
        mIsClose = true;
        showSyncingProgressDialog();
        CRMokoSupport.getInstance().sendOrder(OrderTaskAssembler.setClose());
    }
